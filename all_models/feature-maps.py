...
tensorboard = TensorBoard(log_dir="/kaggle/working/logs/more_feature_maps")
class ModelTraining:
        ...
        def model_build(self):
            model = Sequential()
            model.add(Conv2D(70, kernel_size=(7, 7), strides=2,padding='SAME', activation='relu', input_shape=(227,227,1)))
            model.add(MaxPooling2D(pool_size=(2, 2), strides=2))
            model.add(Conv2D(130, (5, 5), strides=2, activation='relu', padding='SAME'))
            model.add(MaxPooling2D(pool_size=(2, 2), strides=2))
            model.add(Conv2D(260, (3, 3), strides=1, activation='relu', padding='SAME'))
            model.add(Conv2D(380, (3, 3), strides=1, activation='relu', padding='SAME'))
            model.add(Conv2D(260, (3, 3), strides=1, activation='relu', padding='SAME'))
            model.add(Conv2D(260, (3, 3), strides=1, activation='relu', padding='SAME'))
            model.add(MaxPooling2D(pool_size=(2, 2), strides=2))
...
def main():
    ...
    modelTraining.model_train("/kaggle/working/more_feature_maps")
