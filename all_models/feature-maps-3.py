...
tensorboard = TensorBoard(log_dir="/kaggle/working/logs/feature_maps3")
class ModelTraining:
        ...
        def model_build(self):
            model = Sequential()
            model.add(Conv2D(85, kernel_size=(7, 7), strides=2,padding='SAME', activation='relu', input_shape=(227,227,1)))
            model.add(MaxPooling2D(pool_size=(2, 2), strides=2))
            model.add(Conv2D(138, (5, 5), strides=2, activation='relu', padding='SAME'))
            model.add(MaxPooling2D(pool_size=(2, 2), strides=2))
            model.add(Conv2D(280, (3, 3), strides=1, activation='relu', padding='SAME'))
            model.add(Conv2D(400, (3, 3), strides=1, activation='relu', padding='SAME'))
            model.add(Conv2D(280, (3, 3), strides=1, activation='relu', padding='SAME'))
            model.add(Conv2D(280, (3, 3), strides=1, activation='relu', padding='SAME'))
            model.add(MaxPooling2D(pool_size=(2, 2), strides=2))
...
def main():
    ...
    modelTraining.model_train("/kaggle/working/feature_maps3")
