...
tensorboard = TensorBoard(log_dir="/kaggle/working/logs/multiple_layers_10_epochs")
class ModelTraining:
...
def main():
    ...
    modelTraining.model_train("/kaggle/working/model_10_epochs_dense_2_3x3conv2d")
