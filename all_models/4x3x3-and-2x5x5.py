...
tensorboard = TensorBoard(log_dir="/kaggle/working/logs/multiple_layers_10_epochs_3x3_5x5")
class ModelTraining:
...
def main():
    ...
    modelTraining.model_train("/kaggle/working/model_10_epochs_dense_4_3x3conv2d_2_5x5conv2d")
