...
tensorboard = TensorBoard(log_dir="/kaggle/working/logs/multiple_layers_10_epochs_6_3x3_3_5x5Conv")
class ModelTraining:
...
def main():
    ...
    modelTraining.model_train("/kaggle/working/model_10_epochs_dense_6_3x3conv2d_3_5x5con2d")
